...
/*   Updated: 2022/09/28 19:17:39 by minjungk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	swap(struct s_push_swap *ps, char cmd)
{
	if (ps == 0)
		return (-1);
	if (cmd == 'a')
		return (ps->a.swap(&ps->a));
	if (cmd == 'b')
		return (ps->b.swap(&ps->b));
	if (cmd != 's')
		return (-1);
